...
A living system runs: **Sense → Interpret → Propose → Verify → HITL → Act → Learn** — with measurable outputs and hard guardrails. AI proposes; humans approve.
...
## Eight repositories · one supervised LOS

1. zzpackage — Wizard Cash Engine  
2. app.flexgrafik.nl — Lead magnet game  
3. jadzia-core — Chief Operating Intelligence (COI)  
4. agent-os — Agent workforce  
5. flex-vcms — Governance layer  
6. flexgrafik-nl — Trust Portal  
7. flexgrafik-meta — Method / Guard DNA  
8. agent-os-ui — Mission Control  

---

## Enterprise pattern

- **Applications** — Wizard, Game, Portal (touchpoints)  
- **Governance** — Jadzia COI + VCMS + Meta (policy, HITL)  
- **AI Services** — Anthropic, OpenRouter, MCP (tools)
